...
import { reset, transferRequest, verifyTransfer } from "../../state/transaction-state/transferSlice";
...
const VerifyTransfer = () => {
    ...
    const {transaction,verifiedTransactionId,codeWasSent,message,isVerified,targetUser,operationDetails,status,error}=useSelector(state=>state.transfer);
